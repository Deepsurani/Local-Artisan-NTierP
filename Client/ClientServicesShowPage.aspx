<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientMasterPage.master" AutoEventWireup="true" CodeFile="ClientServicesShowPage.aspx.cs" Inherits="Client_ClientServicesShowPage" %>
                      ...
                      <div class="grid-item col featured">
                            ...
                            <div class="product-info">
                                <%--<h6 class="title"><a href="#">3D Attractive Pot</a></h6>--%>
                                    <h6 class="title"><%#Eval("ServiceTitle") %></h6>
