<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientMasterPage.master" AutoEventWireup="true" CodeFile="ClientProductShowPage.aspx.cs" Inherits="Client_ClientProductShowPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" Runat="Server">
    ...
    <div class="page-title-section section" data-bg-image="assets/images/bg/page-title-1.png">
        <div class="container">
            <div class="row">
                <div class="col">
                      ...
                      <div class="grid-item col featured">
                            ...
                            <div class="product-thumb">
                                <a href="#" class="image">
                                    ...
                                    <%--<img src="assets/images/product/s328/product-17.png" alt="Product Image">
                                    <img class="image-hover " src="assets/images/product/s328/product-17-hover.png" alt="Product Image">--%>

                               <asp:Image ID="img1" Class="ImgClass"   ImageUrl='<%#Eval("Photo1") %>' runat="server" />
                               <asp:Image ID="Image1"  class="image-hover ImgClass "  ImageUrl='<%#Eval("Photo2") %>' runat="server" />
                            ...
                            <div class="product-info">
                                <%--<h6 class="title"><a href="#">3D Attractive Pot</a></h6>--%>
                                    <h6 class="title"><%#Eval("ProductTitle") %></h6>

                                <span class="price">
                                    <%#Eval("Price")%>
                                </span>
                                <div class="product-buttons">
                                    <a href='ClientProductDetailsPage.aspx?ProductDetails=<%#Eval("ProductId")%>' class="product-button hintT-top" data-hint="Quick View"><i class="fas fa-search"></i></a>
