<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientMasterPage.master" AutoEventWireup="true" CodeFile="ClientAboutPage.aspx.cs" Inherits="Client_ClientAboutPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" Runat="Server">
        ...
        <div class="container">
            <div class="row learts-mb-n30">
                ...
                <div class="col-lg-6 col-12 text-center learts-mb-30">
                    <img src="assets/images/about/about-7.png" alt="">
                </div>
    ...
    <div class="section">
        <div class="video-banner" data-bg-image="assets/images/banner/video/video-banner-1.png">
            <div class="content">
                ...
                <div class="col learts-mb-50">
                    ...
                    <div class="instafeed instafeed-carousel instafeed-carousel2">
                        <a class="instafeed-item" href="#">
                            <img src="assets/images/instagram/instagram-1.png" alt="instagram image" />
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="instafeed-item" href="#">
                            <img src="assets/images/instagram/instagram-2.png" alt="instagram image" />
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="instafeed-item" href="#">
                            <img src="assets/images/instagram/instagram-3.png" alt="instagram image" />
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="instafeed-item" href="#">
                            <img src="assets/images/instagram/instagram-4.png" alt="instagram image" />
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="instafeed-item" href="#">
                            <img src="assets/images/instagram/instagram-4.png" alt="instagram image" />
